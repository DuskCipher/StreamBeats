...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'I want StreamBeats to keep improving.'**
  ...
  /// No description provided for @importStreamBeatsFiles.
  ///
  /// In en, this message translates to:
  /// **'Import StreamBeats Files'**
  String get importStreamBeatsFiles;
