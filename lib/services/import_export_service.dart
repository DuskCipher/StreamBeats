...
class ImportExportService {
    ...
    try {
      ...
      final Map<String, dynamic> playlistMap = {
        '_meta': {
          ...
          'format': 'v2',
          'note':
              'This file is automatically generated by StreamBeats and is intended solely for importing playlists within the application.',
        },
      ...
      final path = await writeToJSON(
          '${playlistDB.name}_StreamBeatsPlaylist.json', playlistMap,
          path: filePath);
  ...
  static Future<String?> exportTrack(TrackDB trackDB) async {
    try {
      ...
      final path =
          await writeToJSON('${trackDB.title}_StreamBeatsSong.json', trackMap);
